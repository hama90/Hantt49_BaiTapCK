...
public class StepsSoanVaGui {
	...
	public void i_click_link_on_menu(String arg1) throws Exception {
		...
		this.pageAdmin.funcSoanVaGui.click();
	}

	@Then("^I should see form \"([^\"]*)\"$")
	public void i_should_see_form(String arg1) throws Exception {
	    // Write code here that turns the phrase above into concrete actions
	    (new WebDriverWait(driver, 10)).until(ExpectedConditions.visibilityOf(this.pageAdmin.contentHeader));
	    assertEquals(this.pageAdmin.contentHeader.getText(), arg1);
	}
